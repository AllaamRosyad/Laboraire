                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomListTile(
                      ...
                      imagePath: AssetsManager
                          .shoppingCart, // Add an appropriate icon for loans
                      function: () {
                        Navigator.pushNamed(
                          context,
                          '/loanManagement', // Ensure this route is defined in your main.dart
                        );
                      },
                    ),
                    CustomListTile(
...
// Define the CustomListTile widget
class CustomListTile extends StatelessWidget {
  const CustomListTile({
    super.key,
    required this.imagePath,
